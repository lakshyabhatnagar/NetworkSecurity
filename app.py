...
from networksecurity.constants.training_pipeline import DATA_INGESTION_COLLECTION_NAME, DATA_INGESTION_DATABSASE_NAME
...
database = client[DATA_INGESTION_DATABSASE_NAME]
